...
import intellispaces.core.aop.AopFunctions;
...
import intellispaces.core.system.empty.EmptyModule;
import intellispaces.core.system.empty.EmptyModuleWrapper;
...
public class ModuleFactory {
  ...
  private ShadowUnit createUnit(Class<?> unitClass, boolean main) {
    ...
    List<intellispaces.core.guide.Guide<?, ?>> unitGuides = GuideFunctions.loadUnitGuides(unitClass, unitInstance);
