 ...
 */
public interface Mover4<S, R, Q1, Q2, Q3, Q4> extends
    Guide4<S, R, Q1, Q2, Q3, Q4>,
    Mover<S, R>,
    Mover5<S, R, Q1, Q2, Q3, Q4, Void>
{
  R move(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3, Q4 qualifier4) throws TraverseException;

  @Override
  default R move(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3, Q4 qualifier4, Void qualifier5) throws TraverseException {
    return move(source, qualifier1, qualifier2, qualifier3, qualifier4);
  }

  @Override
  default R traverse(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3, Q4 qualifier4) throws TraverseException {
    return move(source, qualifier1, qualifier2, qualifier3, qualifier4);
  }
