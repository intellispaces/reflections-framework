 ...
 */
public interface Mover5<S, R, Q1, Q2, Q3, Q4, Q5> extends
    Guide5<S, R, Q1, Q2, Q3, Q4, Q5>,
    Mover<S, R>
{
  R move(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3, Q4 qualifier4, Q5 qualifier5) throws TraverseException;

  @Override
  default R traverse(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3, Q4 qualifier4, Q5 qualifier5) throws TraverseException {
