 ...
 */
public class AutoMover3<S, B, Q1, Q2, Q3> implements AbstractMover3<S, B, Q1, Q2, Q3> {
  ...
  public B move(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3) throws TraverseException {
    return (B) declarativeTaskPlan.execute(source, qualifier1, qualifier2, qualifier3, traverseExecutor);
  }
}
