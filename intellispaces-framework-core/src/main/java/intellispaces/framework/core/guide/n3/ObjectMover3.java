 ...
 */
public class ObjectMover3<S extends ObjectHandleWrapper<S>, B, Q1, Q2, Q3> implements AbstractMover3<S, B, Q1, Q2, Q3> {
  ...
  public ObjectMover3(
    ...
    if (guideMethod.getParameterCount() != 3) {
      throw UnexpectedViolationException.withMessage("Attached guide should have three qualifiers");
    }
    this.tid = tid;
  ...
  public B move(S source, Q1 qualifier1, Q2 qualifier2, Q3 qualifier3) throws TraverseException {
    try {
      GuideLogger.logCallGuide(guideMethod);
      return (B) source.$handle().getGuideAction(transitionIndex).asAction3().execute(qualifier1, qualifier2, qualifier3);
