...
public class MapOfMovingObjectHandleThruTransition2PlanImpl extends AbstractObjectHandleTraversePlan
    implements MapOfMovingObjectHandleThruTransition2Plan
{
  public MapOfMovingObjectHandleThruTransition2PlanImpl(Class<?> objectHandleClass, String tid) {
    super(objectHandleClass, tid);
  }

  @Override
  public TraversePlanType type() {
    return TraversePlanTypes.MapOfMovingObjectHandleThruTransition2;
  }
