...
import intellispaces.jaquarius.processor.channel.ChannelGuideGenerator;
import intellispaces.jaquarius.processor.data.UnmovableDataHandleGenerator;
import intellispaces.jaquarius.processor.domain.CommonObjectHandleGenerator;
import intellispaces.jaquarius.processor.domain.DomainChannelGenerator;
import intellispaces.jaquarius.processor.domain.MovableDownwardObjectHandleGenerator;
import intellispaces.jaquarius.processor.domain.MovableObjectHandleGenerator;
import intellispaces.jaquarius.processor.domain.UnmovableDownwardObjectHandleGenerator;
import intellispaces.jaquarius.processor.domain.UnmovableObjectHandleGenerator;
import intellispaces.jaquarius.processor.guide.AutoGuideGenerator;
import intellispaces.jaquarius.processor.objecthandle.MovableObjectHandleWrapperGenerator;
import intellispaces.jaquarius.processor.objecthandle.UnmovableObjectHandleWrapperGenerator;
import intellispaces.jaquarius.processor.ontology.OntologyChannelGenerator;
import intellispaces.jaquarius.processor.unit.UnitWrapperGenerator;
