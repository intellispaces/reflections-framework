...
public interface TraverseActions {
  ...
  static <S, T> Action1<T, S> mapThruChannel0(
      Class<S> sourceClass, Class<? extends Channel0> channelClass, ObjectForm targetForm
  ) {
  ...
  static <S, T> Action1<T, S> mapThruChannel0(
    ...
    return new MapThruChannel0Action<>(Types.get(sourceClass), channelClass, ObjectForms.Simple);
  }

  static <S, T, Q> Action2<T, S, Q> mapThruChannel1(
      Class<S> sourceClass, Class<? extends Channel1> channelClass, ObjectForm targetForm
  ) {
  ...
  static <S, T, Q> Action2<T, S, Q> mapThruChannel1(
    ...
    return new MapThruChannel1Action<>(Types.get(sourceClass), channelClass, ObjectForms.Simple);
  }

  static <S, T, Q1, Q2> Action3<T, S, Q1, Q2> mapThruChannel2(
      Class<S> sourceClass, Class<? extends Channel2> channelClass, ObjectForm targetForm
  ) {
  ...
  static <S, T, Q1, Q2, Q3> Action4<T, S, Q1, Q2, Q3> mapThruChannel3(
      Class<S> sourceClass, Class<? extends Channel3> channelClass, ObjectForm targetForm
  ) {
  ...
  static <S, T, Q> Action2<T, S, Q> mapOfMovingThruChannel1(
    ...
    return new MapOfMovingThruChannel1Action<>(Types.get(sourceClass), channelClass, ObjectForms.Simple);
  }
  ...
  static <S, T, Q1, Q2, Q3, Q4> Action5<T, S, Q1, Q2, Q3, Q4> mapOfMovingThruChannel4(
      Class<S> sourceClass, Class<? extends Channel4> channelClass, ObjectForm targetForm
  ) {
