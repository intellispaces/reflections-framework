...
public interface TraverseActions {
  ...
  static <S, T> Action1<T, S> mapThruChannel0(
    ...
    return new MapThruChannel0Action<>(Types.get(sourceClass), channelClass, ObjectReferenceForms.Default);
  }
  ...
  static <S, T, Q> Action2<T, S, Q> mapThruChannel1(
    ...
    return new MapThruChannel1Action<>(Types.get(sourceClass), channelClass, ObjectReferenceForms.Default);
  }
  ...
  static <S, T, Q> Action2<T, S, Q> mapOfMovingThruChannel1(
    ...
    return new MapOfMovingThruChannel1Action<>(Types.get(sourceClass), channelClass, ObjectReferenceForms.Default);
  }
