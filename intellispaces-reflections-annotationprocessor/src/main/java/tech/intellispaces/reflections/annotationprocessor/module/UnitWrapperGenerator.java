...
import tech.intellispaces.reflections.annotation.ProjectionSupplier;
...
import tech.intellispaces.reflections.guide.GuideFunctions;
...
import tech.intellispaces.reflections.system.projection.ProjectionReferences;
...
public class UnitWrapperGenerator extends JaquariusArtifactGenerator {
  ...
  private static boolean isProjectionSupplierDefined(Instance supplierClass) {
    return !tech.intellispaces.reflections.system.ProjectionSupplier.class.getCanonicalName().equals(
