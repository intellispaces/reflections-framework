package tech.intellispaces.reflections.space.channel;
...
public interface ChannelFunctions {
  ...
  static String getUnitGuideChannelId(Object unit, MethodStatement guideMethod) {
    ...
    if (unit instanceof tech.intellispaces.reflections.guide.Guide) {
      var guide = (tech.intellispaces.reflections.guide.Guide<?, ?>) unit;
