...
import tech.intellispaces.reflections.aop.AopFunctions;
import tech.intellispaces.reflections.naming.NameConventionFunctions;
import tech.intellispaces.reflections.system.ModuleFunctions;
import tech.intellispaces.reflections.system.ProjectionDefinition;
import tech.intellispaces.reflections.system.UnitFunctions;
import tech.intellispaces.reflections.system.UnitWrapper;
import tech.intellispaces.reflections.system.empty.EmptyModule;
import tech.intellispaces.reflections.system.empty.EmptyModuleWrapper;
...
class ModuleFactory {
  ...
  static List<Unit> createUnits(List<Class<?>> unitClasses) {
    if (unitClasses == null || unitClasses.isEmpty()) {
      ...
      if (unitclass.isAnnotationPresent(tech.intellispaces.reflections.annotation.Module.class)) {
  ...
  static ProjectionRegistry createProjectionRegistry(List<Unit> units) {
    ...
    units.stream()
        .map(tech.intellispaces.reflections.system.Unit::projectionDefinitions)
        .flatMap(List::stream)
  ...
  static void applyGuideActionAdvises(Unit unit, ProjectionRegistry projectionRegistry) {
    List<tech.intellispaces.reflections.system.UnitGuide<? ,?>> guides = unit.guides();
    for (tech.intellispaces.reflections.system.UnitGuide<?, ?> guide : guides) {
