package tech.intellispaces.reflectionsj.annotationprocessor.module;
...
import tech.intellispaces.reflectionsj.annotation.ProjectionSupplier;
...
import tech.intellispaces.reflectionsj.system.projection.ProjectionReferences;
...
public class UnitWrapperGenerator extends JaquariusArtifactGenerator {
  ...
  private static boolean isProjectionSupplierDefined(Instance supplierClass) {
    return !tech.intellispaces.reflectionsj.system.ProjectionSupplier.class.getCanonicalName().equals(
