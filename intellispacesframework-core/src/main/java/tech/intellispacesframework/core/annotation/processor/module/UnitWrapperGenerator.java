...
import tech.intellispacesframework.core.annotation.ProjectionDefinition;
...
import tech.intellispacesframework.core.system.Injection;
import tech.intellispacesframework.core.system.Modules;
import tech.intellispacesframework.core.system.ProjectionInjection;
import tech.intellispacesframework.core.system.ProjectionInjectionImpl;
import tech.intellispacesframework.core.system.ProjectionRegistry;
import tech.intellispacesframework.core.system.UnitWrapper;
...
import tech.intellispacesframework.javastatements.statement.instance.ClassInstance;
...
public class UnitWrapperGenerator extends AbstractGenerator {
  ...
  private void addProjectionOverrideMethod(MethodStatement projectionMethod) {
    ...
    Action addCommaToSignatureAction = addSeparatorAction(signature, ", ");
  ...
  private void addProjectionProxyMethod(MethodStatement method) {
    ...
    Action addCommaToSignatureAction = addSeparatorAction(signature, ", ");
    Action addCommaToBodyAction = addSeparatorAction(body, ", ");
