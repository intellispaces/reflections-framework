...
import tech.intellispaces.reflections.engine.description.ObjectHandleMethodDescription;
...
@AutoService(tech.intellispaces.reflections.engine.JaquariusEngine.class)
public class JaquariusEngine implements tech.intellispaces.reflections.engine.JaquariusEngine {
  ...
  public <H, W extends H> ObjectHandleTypeDescription registerObjectHandleType(
    ...
    return new tech.intellispaces.reflections.engine.impl.ObjectHandleTypeDescription(
        objectHandleClass,
        wrapperClass,
  ...
  public <W> ObjectHandleBroker registerObjectHandle(W objectHandleWrapper, ObjectHandleTypeDescription type) {
    var typeImpl = (tech.intellispaces.reflections.engine.impl.ObjectHandleTypeDescription) type;
    return new tech.intellispaces.reflections.engine.impl.ObjectHandleBroker(
        type,
