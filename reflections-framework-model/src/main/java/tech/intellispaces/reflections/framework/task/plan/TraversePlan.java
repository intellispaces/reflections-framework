...
/**
 * The plan to traverse source reflection in semantic space.
 */
public interface TraversePlan extends TaskPlan {
   ...
   */
  Object execute(TraverseExecutor executor) throws TraverseException;
