...
public class MapOfMovingSourceSpecifiedClassThruIdentifiedChannelPlanImpl
  extends AbstractTraverseSpecifiedClassSourceThruIdentifierChannelTraversePlan
  implements MapOfMovingSourceSpecifiedClassThruIdentifiedChannelPlan
{
  public MapOfMovingSourceSpecifiedClassThruIdentifiedChannelPlanImpl(Class<?> reflectionClass, Rid cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TaskPlanType type() {
    return TaskPlanTypes.MapOfMovingSourceSpecifiedClassThruIdentifiedChannel;
  }
