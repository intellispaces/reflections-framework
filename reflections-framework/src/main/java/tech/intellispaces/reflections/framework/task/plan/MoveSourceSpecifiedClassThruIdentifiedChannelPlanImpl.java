...
public class MoveSourceSpecifiedClassThruIdentifiedChannelPlanImpl
    extends AbstractTraverseSpecifiedClassSourceThruIdentifierChannelTraversePlan
    implements MoveSourceSpecifiedClassThruIdentifiedChannelPlan
{
  public MoveSourceSpecifiedClassThruIdentifiedChannelPlanImpl(Class<?> reflectionClass, Rid cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TaskPlanType type() {
    return TaskPlanTypes.MoveSourceSpecifiedClassThruIdentifiedChannel;
  }
  ...
  public Object execute(
    ...
    throw NotImplementedExceptions.withCode("TVIo0Q");
  }
}
