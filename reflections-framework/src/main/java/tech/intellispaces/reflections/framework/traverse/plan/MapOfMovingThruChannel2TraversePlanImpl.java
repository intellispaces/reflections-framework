...
public class MapOfMovingThruChannel2TraversePlanImpl extends AbstractTraverseThruChannelPlan
    implements MapOfMovingThruChannel2TraversePlan
{
  public MapOfMovingThruChannel2TraversePlanImpl(Class<?> reflectionClass, String cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TraversePlanType type() {
    return TraversePlanTypes.MapOfMovingChannel2;
  }
