...
public class MapThruChannel2TraversePlanImpl extends AbstractTraverseThruChannelPlan
    implements MapThruChannel2TraversePlan
{
  public MapThruChannel2TraversePlanImpl(Class<?> reflectionClass, String cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TraversePlanType type() {
    return TraversePlanTypes.MapThruChannel2;
  }
