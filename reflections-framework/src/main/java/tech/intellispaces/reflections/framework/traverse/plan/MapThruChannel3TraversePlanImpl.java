...
public class MapThruChannel3TraversePlanImpl extends AbstractTraverseThruChannelPlan
    implements MapThruChannel3TraversePlan
{
  public MapThruChannel3TraversePlanImpl(Class<?> reflectionClass, String cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TraversePlanType type() {
    return TraversePlanTypes.MapThruChannel3;
  }
