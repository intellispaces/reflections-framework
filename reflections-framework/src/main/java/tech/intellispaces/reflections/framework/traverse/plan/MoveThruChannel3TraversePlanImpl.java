...
public class MoveThruChannel3TraversePlanImpl extends AbstractTraverseThruChannelPlan
    implements MoveThruChannel3TraversePlan
{
  public MoveThruChannel3TraversePlanImpl(Class<?> reflectionClass, String cid) {
    super(reflectionClass, cid);
  }

  @Override
  public TraversePlanType type() {
    return TraversePlanTypes.MoveThruChannel3;
  }
