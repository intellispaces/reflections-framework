package tech.intellispaces.reflectionsframework.annotationprocessor.module;
...
import tech.intellispaces.reflectionsframework.annotation.ProjectionSupplier;
import tech.intellispaces.reflectionsframework.annotation.Wrapper;
import tech.intellispaces.reflectionsframework.annotationprocessor.AnnotationGeneratorFunctions;
...
import tech.intellispaces.reflectionsframework.guide.GuideFunctions;
...
import tech.intellispaces.reflectionsframework.system.projection.ProjectionReferences;
...
public class UnitWrapperGenerator extends JaquariusArtifactGenerator {
  ...
  private static boolean isProjectionSupplierDefined(Instance supplierClass) {
    return !tech.intellispaces.reflectionsframework.system.ProjectionSupplier.class.getCanonicalName().equals(
