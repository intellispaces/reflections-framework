...
import tech.intellispaces.reflectionsframework.action.TraverseActions;
...
@AutoService(tech.intellispaces.reflectionsframework.engine.JaquariusEngine.class)
public class JaquariusEngine implements tech.intellispaces.reflectionsframework.engine.JaquariusEngine {
  ...
  public <H, W extends H> ObjectHandleTypeDescription registerObjectHandleType(
    ...
    return new tech.intellispaces.reflectionsframework.engine.impl.ObjectHandleTypeDescription(
        objectHandleClass,
        wrapperClass,
  ...
  public <W> ObjectHandleBroker registerObjectHandle(W objectHandleWrapper, ObjectHandleTypeDescription type) {
    var typeImpl = (tech.intellispaces.reflectionsframework.engine.impl.ObjectHandleTypeDescription) type;
    return new tech.intellispaces.reflectionsframework.engine.impl.ObjectHandleBroker(
        type,
