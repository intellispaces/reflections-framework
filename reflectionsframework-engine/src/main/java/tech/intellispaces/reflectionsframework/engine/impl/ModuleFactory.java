...
import tech.intellispaces.reflectionsframework.aop.AopFunctions;
import tech.intellispaces.reflectionsframework.naming.NameConventionFunctions;
import tech.intellispaces.reflectionsframework.system.ModuleFunctions;
import tech.intellispaces.reflectionsframework.system.ProjectionDefinition;
import tech.intellispaces.reflectionsframework.system.UnitFunctions;
import tech.intellispaces.reflectionsframework.system.UnitWrapper;
import tech.intellispaces.reflectionsframework.system.empty.EmptyModule;
import tech.intellispaces.reflectionsframework.system.empty.EmptyModuleWrapper;
...
class ModuleFactory {
  ...
  static List<Unit> createUnits(List<Class<?>> unitClasses) {
    if (unitClasses == null || unitClasses.isEmpty()) {
      ...
      if (unitclass.isAnnotationPresent(tech.intellispaces.reflectionsframework.annotation.Module.class)) {
  ...
  static ProjectionRegistry createProjectionRegistry(List<Unit> units) {
    ...
    units.stream()
        .map(tech.intellispaces.reflectionsframework.system.Unit::projectionDefinitions)
        .flatMap(List::stream)
  ...
  static void applyGuideActionAdvises(Unit unit, ProjectionRegistry projectionRegistry) {
    List<tech.intellispaces.reflectionsframework.system.UnitGuide<? ,?>> guides = unit.guides();
    for (tech.intellispaces.reflectionsframework.system.UnitGuide<?, ?> guide : guides) {
