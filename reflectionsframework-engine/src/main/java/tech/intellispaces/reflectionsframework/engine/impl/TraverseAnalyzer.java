...
import tech.intellispaces.reflectionsframework.guide.n0.Guide0;
import tech.intellispaces.reflectionsframework.guide.n1.Guide1;
...
import tech.intellispaces.reflectionsframework.traverse.plan.AscendAndExecutePlan1Impl;
import tech.intellispaces.reflectionsframework.traverse.plan.CallGuide0PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.CallGuide1PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.CallGuide2PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.CallGuide3PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.CallGuide4PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.ExecutionTraversePlan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel0Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel0PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel1Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel1PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel2Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel2PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel3Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapObjectHandleThruChannel3PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel0Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel0PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel1Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel1PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel2Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel2PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel3Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel3PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel4Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MapOfMovingObjectHandleThruChannel4PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel0Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel0PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel1Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel1PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel2Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel2PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel3Plan;
import tech.intellispaces.reflectionsframework.traverse.plan.MoveObjectHandleThruChannel3PlanImpl;
import tech.intellispaces.reflectionsframework.traverse.plan.ObjectHandleTraversePlan;
import tech.intellispaces.reflectionsframework.traverse.plan.TraversePlanType;
import tech.intellispaces.reflectionsframework.traverse.plan.TraversePlanTypes;

class TraverseAnalyzer implements tech.intellispaces.reflectionsframework.traverse.plan.TraverseAnalyzer {
