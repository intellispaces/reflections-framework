...
import tech.intellispaces.reflectionsframework.exception.ConfigurationException;
import tech.intellispaces.reflectionsframework.exception.CyclicDependencyException;
import tech.intellispaces.reflectionsframework.samples.object.ObjectReferenceOfEmptyDomain;
import tech.intellispaces.reflectionsframework.samples.system.EmptyTestModule;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithProjectionProvidersWithSelfCyclicDependency;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithSimpleProjections;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithStartupAndShutdownMethods;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithThreeProjectionProvidersWithCyclicDependency;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithTwoProjectionProvidersInDifferentUnitsWithCyclicDependency1;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithTwoProjectionProvidersInDifferentUnitsWithCyclicDependency2;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithTwoProjectionProvidersInDifferentUnitsWithCyclicDependency3;
import tech.intellispaces.reflectionsframework.samples.system.ModuleWithTwoProjectionProvidersWithCyclicDependency;
