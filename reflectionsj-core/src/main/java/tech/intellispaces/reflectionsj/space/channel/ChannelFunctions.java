package tech.intellispaces.reflectionsj.space.channel;
...
import tech.intellispaces.reflectionsj.id.RepetableUuidIdentifierGenerator;
...
public interface ChannelFunctions {
  ...
  static String getUnitGuideChannelId(Object unit, MethodStatement guideMethod) {
    ...
    if (unit instanceof tech.intellispaces.reflectionsj.guide.Guide) {
      var guide = (tech.intellispaces.reflectionsj.guide.Guide<?, ?>) unit;
