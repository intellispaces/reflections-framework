...
import tech.intellispaces.reflectionsj.action.TraverseActions;
...
import tech.intellispaces.reflectionsj.engine.description.ObjectHandleMethodDescription;
...
@AutoService(tech.intellispaces.reflectionsj.engine.JaquariusEngine.class)
public class JaquariusEngine implements tech.intellispaces.reflectionsj.engine.JaquariusEngine {
  ...
  public <H, W extends H> ObjectHandleTypeDescription registerObjectHandleType(
    ...
    return new tech.intellispaces.reflectionsj.engine.impl.ObjectHandleTypeDescription(
        objectHandleClass,
        wrapperClass,
  ...
  public <W> ObjectHandleBroker registerObjectHandle(W objectHandleWrapper, ObjectHandleTypeDescription type) {
    var typeImpl = (tech.intellispaces.reflectionsj.engine.impl.ObjectHandleTypeDescription) type;
    return new tech.intellispaces.reflectionsj.engine.impl.ObjectHandleBroker(
        type,
