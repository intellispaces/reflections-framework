...
import tech.intellispaces.reflectionsj.aop.AopFunctions;
import tech.intellispaces.reflectionsj.naming.NameConventionFunctions;
import tech.intellispaces.reflectionsj.system.ModuleFunctions;
import tech.intellispaces.reflectionsj.system.ProjectionDefinition;
import tech.intellispaces.reflectionsj.system.UnitFunctions;
import tech.intellispaces.reflectionsj.system.UnitWrapper;
import tech.intellispaces.reflectionsj.system.empty.EmptyModule;
import tech.intellispaces.reflectionsj.system.empty.EmptyModuleWrapper;
...
class ModuleFactory {
  ...
  static List<Unit> createUnits(List<Class<?>> unitClasses) {
    if (unitClasses == null || unitClasses.isEmpty()) {
      ...
      if (unitclass.isAnnotationPresent(tech.intellispaces.reflectionsj.annotation.Module.class)) {
  ...
  static ProjectionRegistry createProjectionRegistry(List<Unit> units) {
    ...
    units.stream()
        .map(tech.intellispaces.reflectionsj.system.Unit::projectionDefinitions)
        .flatMap(List::stream)
  ...
  static void applyGuideActionAdvises(Unit unit, ProjectionRegistry projectionRegistry) {
    List<tech.intellispaces.reflectionsj.system.UnitGuide<? ,?>> guides = unit.guides();
    for (tech.intellispaces.reflectionsj.system.UnitGuide<?, ?> guide : guides) {
